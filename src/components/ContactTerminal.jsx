...
export default function ContactTerminal() {
  ...
  return (
    <section className="px-6 border-t border-slate-200 pt-16 pb-20">
      ...
      {/* Outside Coordinates Matrix */}
      <div className="flex items-center gap-6 mb-10 font-mono text-xs md:text-sm mt-8">
        <a href="mailto:your.email@domain.com" className="flex items-center gap-2 text-slate-900 hover:text-emerald-600 transition-colors font-bold">
        ...
        <a href="https://github.com" target="_blank" rel="noreferrer" className="flex items-center gap-2 text-slate-900 hover:text-emerald-600 transition-colors font-bold">
          <svg 
            xmlns="http://w3.org" 
            width="16" 
            height="16" 
      ...
      <div className="w-full border-t border-b border-slate-200 py-8 font-mono text-xs md:text-sm text-slate-900 relative">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 max-w-4xl">
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="flex flex-wrap items-center gap-1 w-full relative group">
              ...
              <div className="relative flex items-center flex-1 min-w-[220px]">
                {/* Instant-blink Step Animation Cursor */}
                {!email && (
          ...
          <div className="flex items-start gap-6">
            ...
            <div className="flex items-start gap-1 w-full relative group">
              ...
              <div className="relative flex items-start flex-1 w-full">
                {/* Instant-blink Step Animation Cursor */}
                {!message && (
