  ...
  return (
    <footer className="w-full border-t border-border-subtle bg-white py-8 px-6 font-mono text-[11px] text-fg-muted">
      <div className="mx-auto max-w-5xl flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
        ...
        {/* Left Column: Copyright & Status Flag */}
        ...
        <div className="flex flex-wrap items-center gap-x-6 gap-y-2 font-bold uppercase tracking-wider">
          ...
          <Link to="/archive" className="hover:text-fg-main transition-colors">
            Archive
          </Link>
          ...
          <a 
            ...
            target="_blank" 
            rel="noreferrer" 
            className="flex items-center gap-2 hover:text-fg-main transition-colors"
          >
            <svg 
